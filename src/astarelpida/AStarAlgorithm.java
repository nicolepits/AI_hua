...
public class AStarAlgorithm {
    ...
    protected ArrayList<Node> myNodes = new ArrayList();

    public AStarAlgorithm() {  //constructor 

    }

    protected void create_add_all_nodes() {
        //create nodes 
        ...
        //Iterating List
        Iterator<Node> iterator = myNodes.iterator();
    ...
    protected static void AstarSearch(Node source, Node goal) {                 //FINDS THE PATH BASED ON THE A STAR ALGORITHM 
    ...
    protected static List<Node> printPath(Node target) {  //prints the path from source node to destination node 
